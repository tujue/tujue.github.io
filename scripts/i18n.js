...
const translations = {
    en: {
        ...
        'resume.designArchitecture': 'Design Architecture',
        'resume.accentColor': 'Accent Color',
        'resume.profileIdentity': 'Profile Identity',
        'resume.fullName': 'Full Name',
        'resume.professionalTitle': 'Professional Title',
        'resume.professionalSummary': 'Professional Summary',
        'resume.contactInformation': 'Contact Information',
        'resume.email': 'Email',
        'resume.phone': 'Phone',
        'resume.location': 'Location',
        'resume.website': 'Website / GitHub',
        'resume.keySkills': 'Key Skills',
        'resume.experienceHistory': 'Experience & History',
        'resume.certificatesAwards': 'Certificates & Awards',
        'resume.references': 'References',
        'resume.cvTitle': 'CURRICULUM VITAE',
        'resume.contact': 'CONTACT',
        'resume.present': 'Present',
        'resume.addReference': 'Add Reference',
        'resume.referenceName': 'Full Name',
        'resume.referencePosition': 'Position / Title',
        'resume.addPosition': 'Add Position',
        'resume.addItem': 'Add Item',
        'resume.downloadPdf': 'Download PDF',
        'resume.printNote': 'For best results, enable "Background Graphics" in print settings.',
        'resume.role': 'Role / Position',
        'resume.company': 'Company / Organization',
        'resume.description': 'Description',
        'resume.removeItem': 'Remove Item',
        'resume.certTitle': 'Certificate / Award Title',
        ...
        'resume.theme.elegant': 'Elegant',
        'resume.theme.creative': 'Creative',
        'resume.theme.cyber': 'Cyber',
        'resume.theme.brutal': 'Brutal',
        'resume.theme.grid': 'Grid',
        'resume.theme.minimal': 'Minimal',
        'resume.theme.compact': 'Compact',
        'resume.theme.timeline': 'Timeline',
        'resume.theme.classic': 'Classic',
        'resume.theme.startup': 'Startup',
        'resume.theme.scholar': 'Scholar',
        'resume.theme.infographic': 'Infographic',
        'resume.theme.magazine': 'Magazine',
        'resume.theme.retro': 'Retro',

        // Cyber Theme
        'resume.cyber.experience': './experience_log.sh',
        'resume.cyber.specs': './system_specs.json',
        'resume.cyber.identity': 'user_identity',
        'resume.cyber.certs': 'certificates.crt',

        // Placeholders
        'resume.placeholder.fullName': 'NAME SURNAME',
        'resume.placeholder.title': 'Job Title / Profession',
        'resume.placeholder.email': 'email@example.com',
        'resume.placeholder.phone': '+00 000 000 00 00',
        'resume.placeholder.location': 'City, Country',
        'resume.placeholder.website': 'github.com/username',
        'resume.placeholder.skills': 'React, Node.js, JS...',
        'resume.placeholder.role': 'e.g. Software Engineer',
        'resume.placeholder.company': 'Company Name',
        'resume.placeholder.cert': 'e.g. AWS Certified',
        'resume.placeholder.issuer': 'Organization',
        'resume.placeholder.year': '2024',
        'resume.placeholder.date': 'e.g. 2020 - 2023',
        'resume.placeholder.description': 'Briefly describe your responsibilities and achievements...',
        'resume.placeholder.refName': 'e.g. John Smith',
        'resume.placeholder.refPosition': 'e.g. Senior Manager',

        // CV Section Headers (used in templates)
        ...
        'resume.section.references': 'References',
        'resume.section.contact': 'Contact',
        'resume.section.expertise': 'Expertise',

        // Tool Names & Descriptions
        'tool.resume-builder.name': 'CV Studio PRO',
        'tool.resume-builder.desc': 'Create professional resumes instantly with 15+ premium themes, advanced typography, and PDF export.'
    },
    ...
    tr: {
        ...
        'category.all': 'Tümü',
        'category.text': 'Metin',
        'category.image': 'Görsel',
        'category.code': 'Kod',
        'category.converter': 'Dönüştürücü',
        'category.generator': 'Oluşturucu',
        'category.format': 'Biçimlendirici',
        ...
        'resume.placeholder.summary': 'Kısaca profesyonel geçmişinizden ve hedeflerinizden bahsedin...',
        'resume.placeholder.skills_hint': 'Yeteneklerinizi virgülle ayırarak yazın (örn: JavaScript, React, Node.js)',
        ...
        'tool.resume-builder.name': 'CV Studio PRO',
        'tool.resume-builder.desc': '15+ premium tema, gelişmiş tipografi ve PDF dışa aktarma ile profesyonel CV\'ler anında oluşturun',
        ...
        // Resume Builder (CV Studio)
        'resume.designArchitecture': 'Tasarım Mimarisi',
        'resume.accentColor': 'Vurgu Rengi',
        'resume.profileIdentity': 'Profil Kimliği',
        'resume.fullName': 'Tam Ad',
        'resume.professionalTitle': 'Mesleki Unvan',
        'resume.professionalSummary': 'Profesyonel Özet',
        'resume.contactInformation': 'İletişim Bilgileri',
        'resume.email': 'E-posta',
        'resume.phone': 'Telefon',
        'resume.location': 'Konum',
        'resume.website': 'Web Sitesi / GitHub',
        'resume.keySkills': 'Anahtar Yetenekler',
        'resume.experienceHistory': 'Deneyim ve Geçmiş',
        'resume.certificatesAwards': 'Sertifikalar ve Ödüller',
        'resume.references': 'Referanslar',
        'resume.cvTitle': 'ÖZGEÇMİŞ',
        'resume.contact': 'İLETİŞİM',
        'resume.present': 'Günümüz',
        'resume.addReference': 'Referans Ekle',
        'resume.referenceName': 'Ad Soyad',
        'resume.referencePosition': 'Pozisyon / Unvan',
        'resume.addPosition': 'Pozisyon Ekle',
        'resume.addItem': 'Öğe Ekle',
        'resume.downloadPdf': 'PDF İndir',
        'resume.printNote': 'En iyi sonuç için yazdırma ayarlarında "Arka Plan Grafikleri" seçeneğini etkinleştirin.',
        'resume.role': 'Rol / Pozisyon',
        'resume.company': 'Şirket / Organizasyon',
        'resume.description': 'Açıklama',
        'resume.removeItem': 'Öğeyi Kaldır',
        'resume.certTitle': 'Sertifika / Ödül Başlığı',
        'resume.issuer': 'Veren Kurum',
        'resume.year': 'Yıl',
        'resume.edit': 'DÜZENLE',
        ...
        // Tema İsimleri
        'resume.theme.modern': 'Modern',
        'resume.theme.elegant': 'Zarif',
        'resume.theme.creative': 'Yaratıcı',
        'resume.theme.cyber': 'Siber',
        'resume.theme.brutal': 'Brütal',
        'resume.theme.grid': 'Izgara',
        'resume.theme.minimal': 'Minimal',
        'resume.theme.compact': 'Kompakt',
        'resume.theme.timeline': 'Zaman Çizelgesi',
        'resume.theme.classic': 'Klasik',
        'resume.theme.startup': 'Girişim',
        'resume.theme.scholar': 'Akademik',
        'resume.theme.infographic': 'İnfografik',
        'resume.theme.magazine': 'Dergi',
        'resume.theme.retro': 'Retro',

        // Cyber Tema
        'resume.cyber.experience': './deneyim_kaydi.sh',
        'resume.cyber.specs': './sistem_ozellikleri.json',
        'resume.cyber.identity': 'kullanici_kimligi',
        'resume.cyber.certs': 'sertifikalar.crt',

        // Yer Tutucular
        'resume.placeholder.fullName': 'AD SOYAD',
        'resume.placeholder.title': 'Mesleki Unvan / Pozisyon',
        'resume.placeholder.email': 'isim@ornek.com',
        'resume.placeholder.phone': '+90 000 000 00 00',
        'resume.placeholder.location': 'Şehir, Ülke',
        'resume.placeholder.website': 'github.com/kullaniciadi',
        'resume.placeholder.skills': 'React, Node.js, JS...',
        'resume.placeholder.role': 'örn. Yazılım Mühendisi',
        'resume.placeholder.company': 'Şirket Adı',
        'resume.placeholder.cert': 'örn. AWS Sertifikası',
        'resume.placeholder.issuer': 'Sertifikayı Veren Kurum',
        'resume.placeholder.year': '2024',
        'resume.placeholder.date': 'örn. 2020 - 2023',
        'resume.placeholder.description': 'Sorumluluklarınızı ve başarılarınızı kısaca açıklayın...',
        'resume.placeholder.refName': 'örn. Ahmet Yılmaz',
        'resume.placeholder.refPosition': 'örn. Kıdemli Müdür',

        // CV Section Headers (used in templates)
        'resume.section.profile': 'Profil',
        'resume.section.experience': 'Deneyim',
        'resume.section.education': 'Eğitim',
        'resume.section.skills': 'Yetenekler',
        'resume.section.certificates': 'Sertifikalar',
        'resume.section.references': 'Referanslar',
        'resume.section.contact': 'İletişim',
        'resume.section.expertise': 'Uzmanlık'
    }
};
...
class I18n {
    ...
    t(key, fallback) {
        ...
        // If fallback is provided (even if null/empty), use it. Otherwise use key.
